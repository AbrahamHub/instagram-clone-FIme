export const FOOTER_LINKS = [
  { path: '/123', name: 'Meta' },
  { path: '/', name: 'Introducir' },
  { path: '/accounts/signup', name: 'Blog' },
  { path: '/accounts/login', name: 'Trabajo' },
  { path: '/123/posts', name: 'Ayuda' },
  { path: '/', name: 'API' },
  { path: '/', name: 'Privacidad' },
  { path: '/', name: 'Normas' },
  { path: '/', name: 'Cuenta más relevante' },
  { path: '/', name: 'Ubicación' },
  { path: '/', name: 'Instagram Lite' },
  { path: '/', name: 'Cargar información de contacto y no usuario' },
  { path: '/', name: 'Meta verificado' }
]
