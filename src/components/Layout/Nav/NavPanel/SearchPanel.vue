...
<template>
  ...
  >
    <span class="block m-2 px-4 text-textColor-primary text-2xl font-semibold">Buscar</span>
    <div class="flex flex-col mt-8 flex-1">
      ...
      <div v-if="!isSearch" class="flex-shrink flex-grow basis-0 overflow-y-auto">
        <div class="flex flex-col h-full">
          <div class="flex items-center justify-between my-4 px-6">
            <span class="text-base font-semibold">Reciente</span>
            <span
          ...
          <SearchListVue
            ...
            hasDelete
            notFoundMessage="No hay búsquedas recientes."
      ...
      <div v-else class="flex-shrink flex-grow basis-0 overflow-y-auto">
        <SearchListVue
          ...
          notFoundMessage="No se encuentra ningún resultado."
    ...
    <ConfirmPopup
      v-if="deleteAllPopup"
      title="¿Eliminar el historial de búsqueda?"
      desc="No podrás deshacerlo
             esta acción. Si borra su historial de búsqueda, es posible que aún vea las cuentas que utilizó
             Buscar en resultados sugeridos."
      confirmMessage="Clear all"
      cancelMessage="Otro momento"
