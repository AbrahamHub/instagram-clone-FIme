      ...
      <div class="flex flex-col flex-[2_1_0%]">
        <div class="flex flex-col min-[736px]:flex-row items-start min-[736px]:items-center">
          ...
          <div class="flex flex-wrap ml-0 min-[736px]:ml-4">
            <UiButton v-if="isCurrentUser" secondary>Editar perfil</UiButton>
            <template v-else>
              <UiButton
                class="mr-2 mb-1"
              ...
              <UiButton
                ...
                >Seguir</UiButton
              >
              <UiButton class="mr-2" secondary>Mensajes de texto</UiButton>
              <UiButton secondary>
                <MoreUserIcon />
              </UiButton>
            </template>
          ...
          >
            <RouterLink :to="{ name: 'MutualFollowers' }"
              ...
              <span v-if="user.mutualFollowers && user.mutualFollowers.length > 3">
                y {{ user.mutualFollowers.length - 3 }} otros siguen</span
              >
              Seguir
            </RouterLink>
          </div>
