...
const adjustInputs = computed(() => [
  { title: 'Brillo', name: 'brightness' },
  { title: 'Contraste', name: 'contrast' },
  { title: 'Saturación', name: 'saturate' },
  { title: 'Temperatura', name: 'temperature' },
  { title: 'Nivel de gris', min: 0, name: 'grayscale' },
  { title: 'Grado Sepia', min: 0, name: 'sepia' },
