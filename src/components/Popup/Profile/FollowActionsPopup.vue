    ...
    >
      ...
      >
        <span class="flex-grow mr-3 leading-tight">{{
          isCloseFriend ? 'Mejores amigos' : 'Añadir a tu lista de mejores amigos'
        }}</span>
        <div
      ...
      >
        <span class="flex-grow mr-3 leading-tight">{{
          isFavorite ? 'Quitar a favoritos' : 'Agregar a los favoritos'
        }}</span>
      ...
      <div
        class="flex w-full p-4 hover:bg-[#e5e5e5] border-b border-separator-modal cursor-pointer select-none"
      >
        <span class="flex-grow mr-3 leading-tight">Está prohibido publicar</span>
      ...
      >
        <span class="flex-grow mr-3 leading-tight">Límite</span>
        <fa class="text-textColor-secondary w-4" :icon="['fas', 'chevron-right']" />
      </div>
      <div
        ...
        @click="onUnfollow"
      >
        <span class="flex-grow mr-3 leading-tight">Dejar de seguir</span>
      </div>
    </div>
  </Modal>
</template>
